...
function bones_scripts_and_styles() 
{
  if ( ! is_admin()) {
    ...
    wp_register_style('bones-formstyle', get_stylesheet_directory_uri() . '/library/css/form.css', array(), '', 'all');
...
function bones_main_nav() 
{
  ...
  wp_nav_menu(array(
  	...
  	'menu_class' => 'ul-reset reset',         // adding custom nav class
...
function bones_page_navi($before = '', $after = '') 
{
	...
	echo $before . '<div id="blog-nav" class="inline left clear-both"><p class="semibold reset left">News</p><ul class="ul-reset reset indexed left">' . "";
	...
	echo '</ul>';
	echo '<ul class="blog-nav ul-reset reset left">';
	echo '<li id="prev">';
